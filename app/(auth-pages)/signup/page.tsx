...
export default function SignUpPage() {
    return (
        ...
        <div className="flex items-center justify-center">
            <span className="inline-block font-bold text-lg w-[90%] text-center text-[#0D0C22] border-b-2 border-[#EEE] pb-[5px]">Sign Up</span>
        </div>
        <form className="size-full flex flex-col justify-between">
            ...
            <div className="flex justify-between">
                <button formAction={signup} className="text-xs font-bold cursor-pointer rounded-[10px] bg-[#0D0C22] text-white px-[20px] py-[10px] shadow-sm transition duration-300 ease-in hover:text-[#0D0C22] hover:bg-[white]">Sign Up</button>
                <Link href="/signin" className="text-xs font-bold text-[#0D0C22] px-[20px] py-[10px] shadow-sm rounded-[10px] transition duration-300 ease-in hover:text-white hover:bg-[#0D0C22]">Sign In</Link>
            </div>
        </form>
        </>
    )
